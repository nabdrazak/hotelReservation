...
class RetrieveGuestDetailsByIdTest {

    @Test
    public void testHandle() throws IOException {
        RetrieveGuestDetailsById microservice = new RetrieveGuestDetailsById();
    ...
    public void newTest() throws IOException {
        ...
        URI testUri = URI.create("http://localhost:9192/retrieveGuestDetailsById?bookedId=78wjthNu");
        when(httpExchange.getRequestURI()).thenReturn(testUri);

        addHotelGuest();
        microservice.copyHandle(httpExchange);

        String expected = "[bookingId='78wjthNu', name='Christopher Hutchinson', roomNo='16', date='Thu Jul 25 00:00:00 MYT 2024']";
